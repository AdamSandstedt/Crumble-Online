...
<div class="card no-padding">
  ...
  <input required size='50' class='form-control' type='text' autocomplete="off" name='website_name' value='<?=$results->website_name; ?>' />
  </div>
  <div class="form-group">
  <label>SMTP Server:</label>
  <input required size='50' class='form-control' type='text' autocomplete="off" name='smtp_server' value='<?=$results->smtp_server; ?>' />
  </div>
  <div class="form-group">
  ...
  <input required size='50' class='form-control' type='text' autocomplete="off" name='from_name' value='<?=$results->from_name; ?>' />
  </div>
  <div class="form-group">
